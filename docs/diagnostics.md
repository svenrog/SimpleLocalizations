...
Sixteen rules, ids `SL1001`–`SL1016`, category `SimpleLocalizations`. All ship at **warning** severity.
...
| `SL1016` | Two `[VocabularyFamily]` claims wording one prefix, which no member lookup can be generated for. |
